...
do
	...
	function section:addTextbox(title, default, callback)
		...
		textbox.MouseButton1Click:Connect(function()
			...
			if textbox.Button.Size ~= UDim2.new(0, 105, 0, 20) then
				return
			end
		...
		input:GetPropertyChangedSignal("Text"):Connect(function()
			...
			if button.ImageTransparency == 0 and (button.Size == UDim2.new(0, 200, 0, 20) or button.Size == UDim2.new(0, 105, 0, 20)) then
				utility:Pop(button, 10)
			end
	...
	function section:updateToggle(toggle, title, value)
		...
		local position = {
			In = UDim2.new(0, 2, 0.5, -8),
			Out = UDim2.new(0, 24, 0.5, -8)
		}
		...
		utility:Tween(frame, {
			...
			Position = position[value] + UDim2.new(0, 0, 0, 4)
		}, 0.2)
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		utility:Tween(dropdown, {Size = UDim2.new(1, 0, 0, (entries == 0 and 32) or math.clamp(entries, 0, 3) * 36 + 40)}, 0.3)
		...
		if entries > 3 then
			...
			frame.CanvasSize = UDim2.new(0, 0, 0, (entries * 36) - 4)
